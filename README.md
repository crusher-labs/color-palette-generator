...
Generate color palettes for websites, apps, and design projects.

Live: <https://crusher-labs.github.io/color-palette-generator/>
...
- Or serve the parent workspace via the hub's preview server: `cd ../../tools-hub && npm run preview` then visit `http://127.0.0.1:8723/utility-tools/color-palette-generator/`.
